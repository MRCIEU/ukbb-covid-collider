...
This document is hosted at https://github.com/MRCIEU/ukbb-covid-collider.
...
We are now ready to generate our bounds for average BMI.
```{r tudball_calculate}
